...
#define DELTA_NS 100000000
#define PERIOD_LP_NS (3 * DELTA_NS)
#define PERIOD_MP_NS (1.2 * DELTA_NS)
#define PERIOD_HP_NS (1.2 * DELTA_NS)
...
struct timespec next_activation_time_ms = TS(0, 0);
int first_activation_m = 1;
